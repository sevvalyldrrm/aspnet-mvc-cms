...
namespace Cms.Data.DataContext
{
 ...
 //           modelBuilder.Entity<Department>().HasData(
	...
	//	new Blog { Id = 2, AppUserId = "2", Title = "Spor Dünyası", Content = "Spor dünyasından son gelişmeler." },
	//	new Blog { Id = 3, AppUserId = "242356sdfhgjk", Title = "Sağlıklı Yaşam", Content = "Sağlıklı yaşam için ipuçları." },
	//	new Blog { Id = 4, AppUserId = "3", Title = "Eğitimde Yenilikler", Content = "Eğitim alanında yaşanan son gelişmeler." },
	//	new Blog { Id = 5, AppUserId = "5", Title = "Ekonomi Analizi", Content = "Dünya ekonomisine genel bir bakış." },
	//	new Blog { Id = 6, AppUserId = "6", Title = "Seyahat Rehberi", Content = "Keşfedilecek yeni yerler." },
	//	new Blog { Id = 7, AppUserId = "7", Title = "Sanatın Kalbi", Content = "Sanat dünyasından haberler." },
	//	new Blog { Id = 8, AppUserId = "9", Title = "Moda Dünyasında Neler Oluyor?", Content = "Moda dünyasının nabzı." },
	//	new Blog { Id = 9, AppUserId = "435", Title = "Gastronomi Keşifleri", Content = "Gastronomi dünyasından lezzetli haberler." },
	//	new Blog { Id = 10, AppUserId = "234234", Title = "Teknolojik Gelişmeler", Content = "Teknolojideki son gelişmeler ve inovasyonlar." }
